...
def initial_sol(all_routes, num_customers, v_capacity, num_vehicles, time_lim):
    ...
    solution[tuple(selected_routes)] = {"profit" : total_profit, "time" : total_time, "demand" : total_delivered}
    print("Initial solution:\n{}\n".format(solution))
    return solution

def solve(all_routes, num_customers, v_capacity, num_vehicles, time_lim):
    init_s = initial_sol(all_routes, num_customers, v_capacity, num_vehicles, time_lim)